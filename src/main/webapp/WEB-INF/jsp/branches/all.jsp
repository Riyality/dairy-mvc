									...
									<div class="gridjs-wrapper" style="height: auto;">
										<table role="grid" class="gridjs-table" style="height: auto;">
											<thead class="gridjs-thead">
												<tr class="gridjs-tr">
													<th data-column-id="date" class="gridjs-th"
														style="width: 150px;"><div class="gridjs-th-content">Name</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
													<th data-column-id="name" class="gridjs-th"
														style="width: 150px;"><div class="gridjs-th-content">Owner</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
													<th data-column-id="email" class="gridjs-th"
														style="width: 200px;"><div class="gridjs-th-content">Owner
															Contact</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
													<th data-column-id="id" class="gridjs-th"
														style="width: 150px;"><div class="gridjs-th-content">Start
															Date</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
													<th data-column-id="price" class="gridjs-th"
														style="width: 100px;"><div class="gridjs-th-content">Address</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
													<th data-column-id="quantity" class="gridjs-th"
														style="width: 100px;"><div class="gridjs-th-content">action</div>
														<div class="gridjs-th gridjs-resizable"></div></th>
												</tr>
											</thead>
											<tbody class="gridjs-tbody">
												<c:forEach items="${branches}" var="branch">
													<tr class="gridjs-tr">
														...
														<td data-column-id="quantity" class="gridjs-td"><a
															href="http://localhost:6161/branches/${branch.id }"><i class="ti ti-color-picker" style="font-size: 14px"></i></a></td>
													</tr>
												</c:forEach>
											</tbody>
										</table>
