				...
				<div class="profile-upperNavbar">
					<li class="nav-item dropdown info-User-Profile"><a
						...
						data-bs-toggle="dropdown" aria-expanded="false"> <i
							...
							<div class="my-0 p-0  ">
								<h6 class="m-0 p-0">Raju Ghadge</h6>
								<p class="m-0 p-0">Operator</p>
							</div>
	...
	<div class="l-navbar" id="nav-bar">
		<nav class="nav">
			<div class="side-navbar">
				...
				<a href="#" class="nav_link"> <span
					class="nav_name" style="font-size: 18px">Dairy Management</span>
				</a>
				...
				<div class="nav_list">
					<ul style="padding: 5px !important;">
						...
						<li><a href="/branches/add-branch-page" class="nav_link"> <i
								class="fa-solid fa-hospital-user"></i><span class="nav_name">Add
									Branch</span>
						</a></li>
						<li><a href="/branches" class="nav_link"><i
